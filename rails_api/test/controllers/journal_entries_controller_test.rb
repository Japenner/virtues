...
class JournalEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journal_entry" do
    assert_difference("JournalEntry.count") do
      post journal_entries_url, params: { journal_entry: { user_id: @journal_entry.user_id, virtue_id: @journal_entry.virtue_id } }, as: :json
    end
  ...
  test "should update journal_entry" do
    patch journal_entry_url(@journal_entry), params: { journal_entry: { user_id: @journal_entry.user_id, virtue_id: @journal_entry.virtue_id } }, as: :json
    assert_response :success
  end
