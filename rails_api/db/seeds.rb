Virtue.create([
  ...
  { name: 'Frugality', description: 'Make no expense but to do good to others or yourself; waste nothing.' },
  { name: 'Industry', description: 'Lose no time; be always employed in something useful; cut off all unnecessary actions.' },
  { name: 'Sincerity', description: 'Use no hurtful deceit; think innocently and justly; speak accordingly.' },
  ...
  { name: 'Cleanliness', description: 'Tolerate no uncleanliness in body, clothes, or habitation.' },
  { name: 'Tranquility', description: 'Be not disturbed at trifles, or at accidents common or unavoidable.' },
...
puts 'Virtues seeded successfully!'
